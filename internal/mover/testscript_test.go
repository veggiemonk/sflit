...
func TestMain(m *testing.M) {
	scripttest.Main(m, map[string]func(){
		...
		"gotypecheck": func() {
			if err := mover.TypeCheckFiles(os.Args[1:]...); err != nil {
		...
		"sflit-lockhold": func() {
			...
			os.Exit(mover.LockHoldMain(os.Args[1], os.Stdin, os.Stdout, os.Stderr))
		},
		"sflit-lockstress": func() {
			...
			os.Exit(mover.LockStressMain(n, os.Args[2:], os.Stderr))
		},
	})
}
